package com.base.library.ui.refresh;/*
 ...
 * </p>
 */
public class AppRefreshLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    private static final String LOG_TAG = AppRefreshLayout.class.getSimpleName();
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        /**
         * Constructor called from {@link AppRefreshLayout#onSaveInstanceState()}
         */
    ...
    /**
     * Set a callback to override {@link AppRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link AppRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link AppRefreshLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull AppRefreshLayout parent, @Nullable View child);
    }
}
