...
class CircleImageView extends AppCompatImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray colorArray = getContext().obtainStyledAttributes(R.styleable.AppRefreshLayout);
        mBackgroundColor = colorArray.getColor(
                R.styleable.AppRefreshLayout_ProgressSpinnerBackgroundColor, DEFAULT_BACKGROUND_COLOR);
        colorArray.recycle();
